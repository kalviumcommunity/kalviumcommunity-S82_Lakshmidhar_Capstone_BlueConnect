        ...
        <div className="p-6">
          <div className="flex flex-col md:flex-row items-start">
            ...
            <div className="flex-1">
              {/* Worker Name */}
              <h2 className="text-2xl font-semibold text-blue-600">{worker.name}</h2>
              ...
              <div className="flex items-center text-gray-600 mt-3">
                ...
                <span className="ml-2 text-sm">({worker.completedJobs} jobs completed)</span>
              </div>
            ...
            <div className="md:ml-auto mt-4 md:mt-0 text-right">
              <div className="text-xl font-bold text-blue-600">${worker.hourlyRate}/hr</div>
